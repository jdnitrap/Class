# CP01_Piping - Exam Questions

## Question ID: 1
### Question: What is the primary purpose of piping in a power plant?

**Options:**
- a) To transport fluids from one piece of equipment to another
- b) To regulate system pressure
- c) To store fluids for later use
...
## Question ID: 2
### Question: Which piping material is typically used for high-temperature applications due to greater resistance to wear, fatigue, and corrosion?
...
## Question ID: 3
### Question: Which piping material is normally chosen for systems connected to the reactor because corrosion product generation must be minimized?
...
## Question ID: 4
### Question: Which of the following is NOT one of the five principal functions of valves?

**Options:**
- a) Starting/stopping flow
- b) Throttling flow
...
## Question ID: 5
### Question: What is the primary function of the backseat in a valve?

**Options:**
- a) To seal the valve seat
- b) To remove system pressure from the packing to allow packing replacement while the system is pressurized
...
## Question ID: 6
### Question: Gate valves are primarily used as isolation valves rather than for throttling because:

**Options:**
- a) They are more expensive than globe valves
- b) Positioning the disk in the flow stream causes turbulence and accelerated wear
...
## Question ID: 7
### Question: Why are globe valves preferred for throttling?

**Options:**
- a) They are cheaper than gate valves
- b) The disk is beveled and seats at nearly right angles to the flow path
...
## Question ID: 8
### Question: Which statement is true about Kerotest valves?

**Options:**
- a) They go from full closed to full open in approximately 1¼ turns
- b) They are best for isolation applications only
...
## Question ID: 9
### Question: Why should operators avoid over-torquing a Kerotest valve?

**Options:**
- a) It wastes energy
- b) Excessive torque can crush or deform the disk, preventing the valve from opening later
...
## Question ID: 10
### Question: What feature makes a needle valve suitable for precise flow control?

**Options:**
- a) Its large bore diameter
- b) Its long, narrow, cone-shaped stem tip
...
## Question ID: 11
### Question: Butterfly valves are typically used in:

**Options:**
- a) Small diameter, high pressure applications
- b) Large diameter, high flow, low pressure applications (e.g., circulating water)
- c) Cryogenic systems
...
## Question ID: 12
### Question: What is the main advantage of a diaphragm valve with radioactive or corrosive fluids?

**Options:**
- a) It can handle very high pressures
- b) The fluid is completely separated from the moving parts, resulting in zero stem leakage
...
## Question ID: 13
### Question: What is the primary purpose of check valves?

**Options:**
- a) To throttle fluid flow
- b) To allow flow in only one direction and prevent reverse flow
...
## Question ID: 14
### Question: What is the key difference between a safety valve and a relief valve?

**Options:**
- a) Safety valves are used for liquids, relief valves for gases
- b) Safety valves pop fully open with little or no accumulation, while relief valves require accumulation
...
## Question ID: 15
### Question: What is the primary function of a vacuum breaker?

**Options:**
- a) To prevent excessive pressure buildup
- b) To protect a tank or vessel from collapsing due to low internal pressure
...
## Question ID: 16
### Question: What is the correct definition of 'Fail As Is' for valve actuators?

**Options:**
- a) The valve opens when power is lost
- b) The valve closes when power is lost
...
## Question ID: 17
### Question: Key precaution when manually operating a Motor Operated Valve (MOV):

**Options:**
- a) Always tag out the power supply to the motor before using the handwheel (when feasible)
- b) Use a wrench to increase torque application
...
## Question ID: 18
### Question: When verifying position of a manual valve locally, operators should first attempt to turn the handwheel in which direction?

**Options:**
- a) Open direction
- b) Closed direction (negligible effect if already closed)
- c) It doesn't matter
- d) Clockwise only
...
## Question ID: 19
### Question: According to SOER 85-2, one primary method to prevent valve mispositioning is:

**Options:**
- a) Install redundant valve position indicators
- b) Verify that all local and remote indications reflect actual plant conditions before and after manipulation
...
## Question ID: 20
### Question: What is a major failure mechanism of gate valves discussed in the lesson?

**Options:**
- a) Corrosion of the bonnet
- b) Thermal binding or pressure locking
...
## Question ID: 70
### Question: What is the primary design consideration for piping in a power plant system?

**Options:**
- a) Color of the pipe paint
- b) Fluid temperature, fluid pressure, flow rate/velocity, chemical/physical properties, and shock loads
...
## Question ID: 71
### Question: Copper alloys are typically chosen for which piping application?

**Options:**
- a) High-temperature steam lines
- b) Corrosive seawater or cooling water systems where corrosion resistance and conductivity are needed
...
## Question ID: 72
### Question: Which type of pipe support is designed to limit seismic motion while allowing thermal growth?
...
## Question ID: 73
### Question: What is the purpose of thermal insulation on piping?

**Options:**
- a) To increase flow velocity
- b) To protect personnel from hot surfaces and reduce heat loss, also protecting equipment from thermal shock
...
## Question ID: 74
### Question: What is thermal binding in valves?

**Options:**
- a) The bonnet expanding and blocking the stem
- b) Differential thermal contraction between the valve body and disk, potentially binding the disk to the seat
...
## Question ID: 75
### Question: What is pressure locking in a valve?

**Options:**
- a) External pressure preventing the valve from opening
- b) Liquid trapped in the valve bonnet pressurizing as it heats, preventing the valve from opening
...
## Question ID: 76
### Question: What is the primary design characteristic of a swing check valve versus a lift check valve?

**Options:**
- a) Swing check has a hinged disk; lift check has a globe-like body with higher D/P
- b) Both have identical performance
...
## Question ID: 77
### Question: What is a stop check valve designed to do?

**Options:**
- a) Prevent flow in all directions
- b) Allow normal check function but also can be forcibly closed by an external actuator, combining check and isolation functions
...
## Question ID: 78
### Question: Which type of actuator is most associated with MOVs (Motor Operated Valves)?
...
## Question ID: 79
### Question: What hazard can result from using a wrench or valve wrench on an MOV handwheel?

**Options:**
- a) Minor inconvenience
- b) Exceeding mechanical advantage can overstress the actuator gearing/casing, causing catastrophic failure

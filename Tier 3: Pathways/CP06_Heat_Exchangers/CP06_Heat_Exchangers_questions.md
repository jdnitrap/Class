...
## Question ID: 2
### Question: What is the key difference between direct contact and indirect contact heat exchangers?

**Options:**
- a) Direct contact requires higher temperatures than indirect contact
- b) In direct contact, fluids mix together; in indirect contact, fluids are separated by a solid surface
...
## Question ID: 3
### Question: Which type of cooling tower uses fans to blow air into the tower?
...
## Question ID: 4
### Question: What is the primary function of cooling tower fill material?

**Options:**
- a) To increase the weight of the tower
- b) To increase surface area for air-water contact and atomize water for efficient heat transfer
...
## Question ID: 5
### Question: What describes the flow pattern in a main condenser?
...
## Question ID: 6
### Question: Why are parallel-flow heat exchangers rarely used in power plants?

**Options:**
- a) They operate at too high a pressure
- b) They require larger surface area than other types for the same heat load because temperature difference decreases as fluids travel through
...
## Question ID: 7
### Question: What is the heat transfer rate equation used by heat exchanger designers?

**Options:**
- a) Q = m × Cp × ΔT (mass times specific heat times temperature change)
- b) Q = Uo × A × ΔT (heat transfer coefficient times surface area times temperature difference)
...
## Question ID: 8
### Question: What is the main advantage of counter-flow heat exchangers compared to equally-sized parallel-flow exchangers?

**Options:**
- a) They operate at lower pressures
- b) They produce a higher rate of heat transfer because temperature difference is maintained throughout the exchanger
...
## Question ID: 9
### Question: What is a primary advantage of U-tube heat exchangers?

**Options:**
- a) They allow for easier tube surface cleaning
- b) Thermal expansion is simplified and they require only half as many tube-to-sheet joints as straight tube designs
...
## Question ID: 10
### Question: What is a regenerative heat exchanger?

**Options:**
- a) A heat exchanger that recycles the same fluid continuously
- b) A heat exchanger that transfers heat from high temperature fluid to low temperature sections of the same system, minimizing energy loss
...
## Question ID: 11
### Question: Which of the following is NOT a major component of a shell and tube heat exchanger?
...
## Question ID: 12
### Question: How much does a typical 30-foot feedwater heater tube expand when heated from 70°F to 470°F?
...
## Question ID: 13
### Question: What is the purpose of baffles in a shell and tube heat exchanger?

**Options:**
- a) To increase the shell thickness for higher pressure rating
- b) To direct flow over tubes and provide lateral tube support while maintaining overall counter-flow direction
...
## Question ID: 14
### Question: What is thermal shock in heat exchangers and why is it a concern?

**Options:**
- a) Thermal shock is when a heat exchanger operates above its design temperature briefly
- b) Thermal shock is sudden temperature changes that cause differential metal expansion/contraction, potentially causing brittle fracture if pressure is high
...
## Question ID: 15
### Question: What is the correct startup procedure to avoid thermal shock in a heat exchanger?

**Options:**
- a) Introduce hot fluid first, then gradually add cold fluid
- b) Introduce cold fluid first using throttled inlet valves, then gradually add hot fluid to prevent differential thermal expansion
...
## Question ID: 16
### Question: What is water hammer in heat exchangers and how is it minimized?

**Options:**
- a) Water hammer is corrosion; minimized by using stainless steel tubes
- b) Water hammer is a pressure spike from sudden flow velocity changes; minimized by slowly operating isolation valves
...
## Question ID: 17
### Question: What operational factor causes excessive pressure drops and energy loss in heat exchangers?
...
## Question ID: 18
### Question: What does scaling or tube fouling in heat exchangers reduce?
...
## Question ID: 19
### Question: What is the relationship between condenser vacuum and turbine backpressure?

**Options:**
- a) Vacuum and backpressure are independent of each other
- b) Higher vacuum reduces backpressure, creating greater pressure difference across turbine and improving turbine efficiency
...
## Question ID: 20
### Question: Approximately how much cooling water is needed to condense one pound of steam in a condenser?
...
## Question ID: 21
### Question: What is the primary purpose of the air removal system in a condenser?

**Options:**
- a) To prevent moisture from entering the condenser
- b) To remove non-condensable gases (primarily air) that accumulate and reduce condenser vacuum
...
## Question ID: 22
### Question: What indicators suggest that a condenser is experiencing performance degradation?

**Options:**
- a) Increased flow rate through the condenser tubes
- b) Reduced vacuum despite stable load, increased outlet water temperature, and fouling of tubes
...
## Question ID: 23
### Question: What is biofouling in cooling tower and condenser systems?

**Options:**
- a) Corrosion of tube surfaces from acidic water
- b) Growth of aquatic organisms in cooling water systems that reduces cooling effectiveness and increases backpressure
...
## Question ID: 24
### Question: How does the heat transfer rate equation Q = Uo × A × ΔT help optimize heat exchanger performance?

**Options:**
- a) It shows that only temperature difference matters for heat transfer
- b) It shows that increasing the overall heat transfer coefficient, surface area, or temperature difference increases heat transfer rate
...
## Question ID: 25
### Question: What is the significance of logarithmic mean temperature difference (ΔTlm) in counter-flow heat exchanger design?

**Options:**
- a) It indicates the average temperature of the fluids
- b) It accounts for the changing temperature difference throughout the exchanger and is used to calculate overall heat transfer rate

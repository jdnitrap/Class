...
**Options:**
- a) To move fluids and overcome flow resistance
...
**Options:**
- a) It traps fixed volumes and forces them through, not velocity-based
- b) It uses rotating impellers to gain velocity
...
**Options:**
- a) Gallons per minute (gpm) or cubic feet per second (cfs)
- b) Feet of water column
- c) Horsepower
...
**Options:**
- a) The difference in fluid levels (elevation head)
- b) The energy to set fluid in motion
...
**Options:**
- a) Velocity head and friction head
- b) Only static pressure
- c) Only elevation difference
...
**Options:**
- a) The fluid source is below the pump centerline (suction lift)
- b) The pump discharge is restricted
...
**Options:**
- a) Pressure drop in suction line (dynamic head)
- b) Static suction head
- c) Vacuum or pressure in tank
...
**Options:**
- a) The static suction head of the source tank
- b) Static discharge head (elevation)
...
**Options:**
- a) Absolute suction pressure and saturation (vapor) pressure
- b) Total head and static head
...
**Options:**
- a) Pump suction pressure drops to saturation pressure of the fluid
- b) Discharge pressure exceeds design limits
- c) Flow rate increases above rated capacity
...
**Options:**
- a) Increased fluid filtration
- b) Pitting and erosion of the impeller
...
**Options:**
- a) Cavitation is occurring
- b) Normal pump operation
- c) Bearing wear
...
**Options:**
- a) Increasing discharge pressure limit beyond design rating
- b) Using a head tank to create static pressure
...
**Options:**
- a) Air must be vented and suction lines completely filled with fluid
- b) Suction strainers must be installed
- c) System pressure must be reduced
...
**Options:**
- a) The pump performance curve intersects the system resistance curve
- b) Flow rate equals zero
...
**Options:**
- a) Flow rate deviates significantly from design point
- b) Discharge pressure increases
- c) Suction head is positive
...
**Options:**
- a) Higher temperature increases saturation pressure and decreases viscosity, affecting NPSH and flow resistance
- b) Temperature has no effect on pump performance
- c) Lower temperature always improves pump reliability
...
**Options:**
- a) Understand pump theory and recognize abnormal conditions early
- b) Never check pump vibration or temperature

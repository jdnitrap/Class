# TH06B_Fluid_Flow - Exam Questions

## Question ID: 110
### Question: Mass flow rate is defined as:

**Options:**
- a) The volume of fluid passing a reference point per unit time
- b) The mass of fluid passing a reference point per unit time
...
## Question ID: 111
### Question: The mass flow rate equation can be expressed as ṁ = ρ × V̇ = ρ × v × A. Which variable represents the cross-sectional area of flow?
...
## Question ID: 112
### Question: Volumetric flow rate (Q) is commonly expressed in which of the following units?
...
## Question ID: 113
### Question: Steady flow (continuity of flow) occurs when:

**Options:**
- a) The velocity is constant throughout the pipe
- b) The mass flow rate into and out of a system are equal
...
## Question ID: 114
### Question: Viscosity is best defined as:

**Options:**
- a) A fluid's ability to conduct heat
- b) A fluid's density relative to water
...
## Question ID: 115
### Question: How does viscosity of liquids change with increasing temperature?

**Options:**
- a) Viscosity increases significantly
...
## Question ID: 116
### Question: Water at 68°F is used as the reference standard for viscosity measurement. At this temperature, water has a viscosity of:
...
## Question ID: 117
### Question: Specific gravity is defined as:

**Options:**
- a) The mass per unit volume of a fluid
- b) The ratio of a fluid's density compared to water at 60°F
...
## Question ID: 118
### Question: For liquids, as temperature increases, how do viscosity and specific gravity change?
...
**Options:**
- a) High turbulence and cross-currents throughout the pipe
- b) Layers of fluid moving smoothly over adjacent layers
...
**Options:**
- a) Smooth, layered movement of fluid with no cross-currents
- b) Cross-currents set up that disturb the fluid layers
...
## Question ID: 121
### Question: The Reynolds number is used to determine:

**Options:**
- a) The pressure drop across a valve
- b) Whether flow is laminar, transitional, or turbulent
...
## Question ID: 122
### Question: Single-phase flow occurs when:

**Options:**
- a) The fluid is a mixture of liquid and vapor
- b) The fluid is either completely in liquid state or completely in gaseous state
...
## Question ID: 123
### Question: Two-phase flow greatly increases the resistance to flow primarily because:

**Options:**
- a) The pressure is higher
...
## Question ID: 124
### Question: The elevation head term in Bernoulli's equation represents:

**Options:**
- a) The kinetic energy due to fluid velocity
- b) The potential energy due to elevation above a reference level
...
## Question ID: 125
### Question: The velocity head term in Bernoulli's equation represents:

**Options:**
- a) The height to which flowing fluid would rise if all kinetic energy were converted to potential energy
- b) The height of a column of fluid equivalent to pressure
...
## Question ID: 126
### Question: The pressure head in Bernoulli's equation is expressed as:

**Options:**
- a) The absolute pressure divided by velocity
- b) The height of a column of fluid whose weight equals the pressure
...
## Question ID: 127
### Question: According to Bernoulli's principle, the sum of elevation head, velocity head, and pressure head is called:
...
## Question ID: 128
### Question: Head loss is best defined as:

**Options:**
- a) A decrease in the fluid's temperature due to radiation
- b) The conversion of fluid pressure and velocity to heat energy through friction
...
## Question ID: 129
### Question: In Darcy's equation for head loss (Hf = f × (L/d) × (v²/2gc)), what does the friction factor (f) account for?

**Options:**
- a) Only the pipe length
- b) Only the fluid velocity
...
## Question ID: 130
### Question: According to Darcy's equation, which of the following changes would INCREASE head loss?
...
## Question ID: 131
### Question: Head loss varies with the square of fluid velocity. This means if velocity doubles, head loss will:

**Options:**
- a) Double (increase by 2×)
- b) Quadruple (increase by 4×)
- c) Increase by 50%
- d) Remain unchanged
...
## Question ID: 132
### Question: A system characteristic curve graphically represents:

**Options:**
- a) Pressure versus temperature
- b) Head loss versus volumetric flow rate
...
## Question ID: 133
### Question: Water hammer is defined as:

**Options:**
- a) The sound produced when water flows through a pipe
- b) Pressure fluctuations that develop when flow through a pipe is suddenly changed
...
## Question ID: 134
### Question: In a single-phase water hammer event, the pressure wave is created when:

**Options:**
- a) Water enters a pipe at high velocity
- b) Moving water is suddenly decelerated by a flow restriction
...
## Question ID: 135
### Question: Two-phase water hammers are typically more severe than single-phase hammers because:

**Options:**
- a) The system pressure is higher
- b) The pipe diameter is smaller
...
## Question ID: 136
### Question: The Joukowsky equation describes water hammer pressure change as ΔP = ρ × c × Δv. The term 'c' in this equation represents:

**Options:**
- a) The pressure drop across the restriction
- b) The speed of sound in the fluid
...
## Question ID: 137
### Question: According to the Joukowsky equation for water hammer pressure, peak pressure depends on:

**Options:**
- a) Only the pipe length
- b) Only the system pressure
...
## Question ID: 138
### Question: Which of the following is NOT a recommended method for preventing water hammer?

**Options:**
- a) Ensure systems are water-solid before starting pumps
- b) Initiate flow as slowly as possible
...
## Question ID: 139
### Question: A 'keep fill' system is used primarily to:

**Options:**
- a) Reduce system pressure
- b) Prevent void formation and water hammer from column rejoining
...
## Question ID: 140
### Question: When adding heat to a closed system, the pressure increases because:

**Options:**
- a) The fluid volume increases
- b) The density of water changes with temperature increase
...
## Question ID: 141
### Question: When heating a closed system, NPSH (Net Positive Suction Head) decreases because:

**Options:**
- a) The pump speed increases
- b) The system temperature approaches saturation temperature
...
## Question ID: 142
### Question: High point casing vents on centrifugal pumps should be opened before pump start to:

**Options:**
- a) Reduce system pressure
- b) Remove non-condensable gases and prime the pump
...
## Question ID: 143
### Question: When filling a closed system, high point vents should remain open until:

**Options:**
- a) The system reaches operating pressure
- b) A solid stream of fluid comes out
...
## Question ID: 144
### Question: Starting a pump in a system that has been drained is avoided mainly because:

**Options:**
- a) It increases system pressure too much
- b) It could damage the pump due to lack of cooling and lubrication
...
## Question ID: 145
### Question: In the operating experience case OE22415 (Condensate Motor Bearing Failure), the bearing failure was caused by:

**Options:**
- a) Excessive system pressure
- b) High viscosity oil due to cold bearing temperatures
...
## Question ID: 146
### Question: The key lesson from operating experience case SER 16-96 (Reheater Drain Pipe Failure) was that:

**Options:**
- a) Water hammer only causes minor damage
- b) Water hammer could rupture large bore piping and cause personnel injury

...
import simulator_post_1 from "./api/simulator/POST";
import simulator_compare_post_2 from "./api/simulator/compare/POST";
// </api-imports>
...
app.post("/api/simulator", simulator_post_1);
app.post("/api/simulator/compare", simulator_compare_post_2);
// </api-registrations>
